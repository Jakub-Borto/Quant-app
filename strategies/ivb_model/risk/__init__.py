...
fill-simulation helpers (no shared module, no cross-script imports). The order in
RISK_REGISTRY maps to the 1-based `risk_script` param
...
RISK_NAMES    = ["basic_risk", "zone_sl_risk", "vwap_tp_risk", "vwap_trailing_risk"]
