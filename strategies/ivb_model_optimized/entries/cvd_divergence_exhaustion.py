"""CVD divergence (exhaustion) entry.

The mirror of the absorption finder. A cumulative-volume-delta divergence at a price extreme,
read as exhaustion: price DID extend to a new extreme, but CVD COULDN'T follow.

  - SHORT bias (exhaustion at highs): a 2nd pivot high that is higher-or-equal to the 1st,
    yet CVD at the 2nd high is *lower* — price made a higher high on less net buying =>
    buyers exhausted => short.
  - LONG bias (exhaustion at lows): a 2nd pivot low that is lower-or-equal to the 1st, yet
